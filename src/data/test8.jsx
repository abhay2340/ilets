const test8 = {
  ...
  Rawlinson took his copies home to Britain and studied them for years to determine what each line stood for, and what each group of symbols meant. He found that in the writing on those particular rocks every word was repeated three times in three languages: Old Persian, Elamite and Babylonian. Since the meanings in these languages were already known to linguists, he could thus translate the cuneiform. Eventually, he fully decoded the cuneiform marks and he discovered that they described the life of Darius, a king of the Persian Empire in the 5th Century BCE.`,
        ...
        questions: [
          // TRUE / FALSE / NOT GIVEN
          {
            id: 1,
            type: 'mcq',
            question: 'Cuneiform tablets were produced in different shapes and sizes.',
            options: ['TRUE', 'FALSE', 'NOT GIVEN']
          },
          {
            id: 2,
            type: 'mcq',
            question: 'When Sumerian writers marked on the clay tablets, the tablets were dry.',
            options: ['TRUE', 'FALSE', 'NOT GIVEN']
          },
          {
            id: 3,
            type: 'mcq',
            question: 'Cuneiform was often difficult to read because of its size.',
            options: ['TRUE', 'FALSE', 'NOT GIVEN']
          },
          {
            id: 4,
            type: 'mcq',
            question: 'A number of languages adopted cuneiform.',
            options: ['TRUE', 'FALSE', 'NOT GIVEN']
          },
          {
            id: 5,
            type: 'mcq',
            question: 'Cuneiform signs can be found in some modern alphabets.',
            options: ['TRUE', 'FALSE', 'NOT GIVEN']
          },
          ...
          // Complete notes - ONE WORD ONLY
          {
            id: 6,
            type: 'written',
            question: 'tokens, for example, ______, were often used'
          },
          {
            id: 7,
            type: 'written',
            question: 'the first tokens were kept in containers made of ______'
          },
          {
            id: 8,
            type: 'written',
            question: 'tokens were used as a ______ to give when selling something'
          },
          {
            id: 9,
            type: 'written',
            question: 'tokens were put in a container that looked like a clay ______'
          },
          {
            id: 10,
            type: 'written',
            question: 'at first, signs looked like what they indicated, e.g. a ______'
          },
          {
            id: 11,
            type: 'written',
            question: 'eventually, cuneiform signs shaped like ______ were developed'
          },
          {
            id: 12,
            type: 'written',
            question: 'according to experts, cuneiform was mainly used for ______'
          },
          {
            id: 13,
            type: 'written',
            question: 'Rawlinson copied inscriptions onto ______'
          }
        ]
      },
      ...
      {
        title: 'PASSAGE 2',
        passage: `Children's comprehension of television advertising
  ...
  B
  Television has long been the predominant medium that advertisers have chosen for marketing products to children. It is estimated that the average child sees more than 40,000 television commercials a year, most of which are 15 to 30 seconds in length (Kunkel, 2001). According to another estimate, children aged 14 years and under make $424 billion in direct purchases and influence $4190 billion in family purchases, underscoring the high stakes involved (McNeal, 1998). In addition, companies now recognize that brand loyalty built at an early age may reap economic rewards over a child's lifetime (McNeal, 1987).
  ...
  In sum, because young children lack the cognitive skills and abilities of older children and adults, they do not comprehend commercial messages in the same way as more mature audiences, and are therefore uniquely susceptible to advertising influence.`,
        ...
        questions: [
          // Which paragraph contains information (A-H)
          {
            id: 14,
            type: 'written',
            question: 'a description of recent innovations in TV broadcasting'
          },
          {
            id: 15,
            type: 'written',
            question: 'a mention of the main goods and services advertised to children'
          },
          {
            id: 16,
            type: 'written',
            question: 'a reference to a current limitation on television advertising aimed at children'
          },
          {
            id: 17,
            type: 'written',
            question: 'two techniques used to encourage children to watch TV commercials'
          },
          {
            id: 18,
            type: 'written',
            question: 'a type of advertisement that may make children believe the opposite of what is true'
          },
  
          // Match statements with researchers (19-22)
          {
            id: 19,
            type: 'matchinggroup',
            subIds: [19, 20, 21, 22],
            displayId: '19–22',
            question: 'Questions 19–22: Match each statement (rows) with the correct researcher (columns). Choose ONE option per row.',
            tableHeader: 'List of researchers',
            columns: [
              'A Kunkel',
              'B Kunkel et al',
              'C McNeal',
          ...
          // Complete summary (NO MORE THAN TWO WORDS)
          {
            id: 23,
            type: 'written',
            question: 'Children below the age of 4 or 5 do not understand the difference between television programmes and commercials. In fact, these children often mistake an advertisement for a ______ from the programme they are watching.'
          },
          {
            id: 24,
            type: 'written',
            question: 'This is despite the fact that children\'s TV programmes usually include announcements called ______ to show that there is going to be a commercial break.'
          },
          {
            id: 25,
            type: 'written',
            question: 'The problem is made more difficult because of a technique called ______ whereby a person or cartoon figure from the programme is used to sell a product during the commercial break.'
          },
          {
            id: 26,
            type: 'written',
            question: 'From the age of 4 or 5, children begin to realise that commercials are different from TV programmes: for example, they may recognise that there is a difference in length or that advertisements are ______ than actual TV.'
          }
        ]
      },
  ...
  We have then a man of myriad and colourful parts, and perhaps not always the easiest of sailors to get along with because of his arrogance and hot temper. But to dwell on these aspects today is to miss the point: it is A New Voyage Round the World that should provide the most illuminating and entertaining of Dampier's legacies. Above all, the text is studded with some wonderfully colourful expressions, and readers will enjoy some of the finest descriptions of storms in the English language, and the liberal wit throughout.`,
        ...
        questions: [
          // Multiple choice A, B, C, D
          {
            id: 27,
            type: 'mcq',
            question: 'Which of the following best summarizes the writer\'s point in the first paragraph?',
            options: [
          ...
          },
          {
            id: 28,
            type: 'mcq',
            question: 'The writer refers to Swift and Defoe in order to',
            options: [
              'provide more information regarding Dampier\'s sources.',
          ...
          },
          {
            id: 30,
            type: 'mcq',
            question: 'What point does the writer make about Dampier in the second paragraph?',
            options: [
              'He could cope with physical hardship.',
              'He was a more adventurous explorer than Cook was.',
              'He had a kinder personality than he is given credit for.',
          ...
          },
          {
            id: 31,
            type: 'mcq',
            question: 'What information is given about Dampier\'s early life?',
            options: [
              'He had a difficult relationship with the people looking after him.',
              'He was different from other youths who went to sea.',
              'He wanted to travel from a young age.',
              'He came from a family of sailors.'
            ]
          },
  
          // Complete summary using list of words (32-35)
          {
            id: 32,
            type: 'matchinggroup',
            subIds: [32, 33, 34, 35],
            displayId: '32–35',
            question: 'Questions 32–35: Complete the summary below using the list of words (columns). Choose ONE option per row.',
            columns: [
            ...
            rows: [
              'The success of the book cannot solely be attributed to the originality of Dampier\'s ______. Readers of the time were fascinated with his stories of the time he spent with outlaws and his colourful way of writing.',
              'It seems certain that Dampier worked on the book with a mystery ______.',
              'Some aspects of A New Voyage Round the World are problematic, descriptions of ______ were inserted into account of Dampier\'s adventures in a way that distracted reader.',
              'It seems that the responsibility of the final version of the book lies with the ______.'
            ]
          },
          ...
          // YES / NO / NOT GIVEN
          {
            id: 36,
            type: 'mcq',
            question: 'Many people wrote biographies of Dampier as a result of personal contact with him.',
            options: ['YES', 'NO', 'NOT GIVEN']
          },
          {
            id: 37,
            type: 'mcq',
            question: 'Dampier was skilled at making money.',
            options: ['YES', 'NO', 'NOT GIVEN']
          },
          {
            id: 38,
            type: 'mcq',
            question: 'Dampier\'s patience was appreciated by his crew.',
            options: ['YES', 'NO', 'NOT GIVEN']
          },
          {
            id: 39,
            type: 'mcq',
            question: 'A New Voyage Round the World is longer than most modern books.',
            options: ['YES', 'NO', 'NOT GIVEN']
          },
          {
            id: 40,
            type: 'mcq',
            question: 'Dampier\'s accounts of bad weather are impressive.',
            options: ['YES', 'NO', 'NOT GIVEN']
          }
        ]
      }

...
By 1800, the average East Indiaman could carry 1,200 tons of merchandise. The trading pattern for China tea usually meant the East Indiamen set sail from Britain in January, sailed round the Cape of Good Hope at the southernmost tip of Africa, and arrived in China in September. There they would load up that year's tea harvest, set off again and, depending on the wind and weather, aim to arrive back by the following September, so even with favourable sailing conditions, the round trip lasted almost two years, and if anything went wrong it could take lot longer.

However, by 1834 the company had lost its trading monopoles, and tea had become a freely traded item. Having no more use for its great ships, the company sold them off, and many were bought by merchants or their captains, who continued to plough the seas between Britain and China. But now that tea could be traded freely. A few smart sailors began to realise that whoever brought each new harvest of tea to Britain first, stood to make the most money.
...
They sped down through the South China Sea and into the Indian Ocean, then raced to get round the southernmost tip of Africa at the Cape of Good Hope. Then it was north across the vast Atlantic, past the Azores, through the English Channel and into the estuary of the River Thames. Once there, they would be towed by tugs, up the river and into the docks. The cargo of the winning ship could earn premium of up to sixpence per pound - and so the captain and crew were rewarded by the owners of the cargo. But the races were about more than just money: the crews, about 40 men on each clipper, were expert sailors, proud of their ships, and they delighted in competing against each other. Without their enthusiasm, the races would never have happened, since home as fast as possible required the crew to be totally dedicated and to sacrifice much of their rest for the duration of the race.`,
...
>>>>>>> Stashed changes
      questions: [
        // TRUE / FALSE / NOT GIVEN
        {
          id: 1,
          type: 'mcq',
          question: 'In the seventeenth and eighteenth centuries, the British East India Company faced a lot of competition.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 2,
          type: 'mcq',
          question: 'Before 1800, cargo size was the most important consideration for the East India Company.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 3,
          type: 'mcq',
          question: 'At best, voyages of the East Indiamen to China and back took nearly two years to complete.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 4,
          type: 'mcq',
          question: 'Before 1834, voyages to and from China were considered to be highly dangerous.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 5,
          type: 'mcq',
          question: 'After 1834, the ships which had served the East India Company stopped being used for commercial purposes.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 6,
          type: 'mcq',
          question: 'In the nineteen century, British drinkers preferred tea made from mature leaves to that made from younger leaves.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },

        // Complete notes - ONE WORD ONLY
        {
          id: 7,
          type: 'written',
          question: 'The ships were remarkable for the number of ______ they had.'
        },
        {
          id: 8,
          type: 'written',
          question: 'The performance of British tea clippers was particularly affected when there were ______ at sea.'
        },
        {
          id: 9,
          type: 'written',
          question: 'It was in a ship called ______ that the British first competed successfully against the Americans.'
        },
        {
          id: 10,
          type: 'written',
          question: 'Competition increased when additional Chinese trading ______ were established.'
        },
        {
          id: 11,
          type: 'written',
          question: 'Merchants were occasionally in such a hurry that they failed to complete the ______ before leaving China.'
        },
        {
          id: 12,
          type: 'written',
          question: 'At the end of their journey, the ships needed the help of ______.'
        },
        {
          id: 13,
          type: 'written',
          question: 'The crews were motivated by both ______ and their enthusiasm for the competition.'
        }
      ]
    },
<<<<<<< Updated upstream
...
>>>>>>> Stashed changes
      questions: [
        // Complete summary (NO MORE THAN TWO WORDS)
        {
          id: 14,
          type: 'written',
          question: 'First type: Birds rely on their sophisticated ______ However, they are generally most successful if they are released within their feeding territory.'
        },
        {
          id: 15,
          type: 'written',
          question: 'Second type: Birds select their accustomed ______, no matter where they are released.'
        },
        {
          id: 16,
          type: 'written',
          question: 'As a result, they may miss their ______.'
        },
        {
          id: 17,
          type: 'written',
          question: 'Third type: Birds orientate correctly, even when they are released in an unfamiliar place and have no ______ to make use of.'
        },
        {
          id: 18,
          type: 'written',
          question: 'One bird with this type of skill is the ______.'
        },

<<<<<<< Updated upstream
        // Which paragraph contains information (A-H)
        {
          id: 19,
          type: 'written',
          question: 'the effects of distance on some birds ability to find their nests'
        },
        {
          id: 20,
          type: 'written',
          question: 'a methodology for testing the general ability of birds to find their nests'
        },
        {
          id: 21,
          type: 'written',
          question: 'one aspect of physical ability in humans and birds'
        },
        {
          id: 22,
          type: 'written',
          question: 'how some birds\' migration was delayed for experimental purposes'
        },

        // Match birds with points (23-26)
=======
        // Which paragraph contains information (A–H) — matchinggroup 19–22
        {
          id: 19,
          type: 'matchinggroup',
          subIds: [19, 20, 21, 22],
          displayId: '19–22',
          question: 'Questions 19–22: Which paragraph contains the following information? Choose ONE letter (A–H) per row.',
        ...
        // Match birds with points (A–G) — matchinggroup 23–26
>>>>>>> Stashed changes
        {
          id: 23,
          type: 'matchinggroup',
          ...
          displayId: '23–26',
<<<<<<< Updated upstream
          question: 'Questions 23–26: Match each bird (rows) with the point which it illustrates (columns). Choose ONE option per row.',
          tableHeader: 'Points which author wishes to illustrate',
          columns: [
            'A an ability to orientate without previous training',
            'B the speed at which birds fly', 
=======
          question: 'Questions 23–26: Match each bird (rows) with the correct point (A–G). Choose ONE option per row.',
          columns: [
            'A an ability to orientate without previous training',
            'B the speed at which birds fly',
>>>>>>> Stashed changes
...
>>>>>>> Stashed changes
      questions: [
        // YES / NO / NOT GIVEN
        {
          id: 27,
          type: 'mcq',
          question: 'The delay in the process used by the Kellogg brothers affected the final product.',
          options: ['YES', 'NO', 'NOT GIVEN']
        },
        {
          id: 28,
          type: 'mcq',
          question: 'Sir Alan Hodgkin is an example of someone whose work proceeded in a logical and systematic way.',
          options: ['YES', 'NO', 'NOT GIVEN']
        },
        {
          id: 29,
          type: 'mcq',
          question: 'Daguerre is an exception to the general rule of innovation.',
          options: ['YES', 'NO', 'NOT GIVEN']
        },
        {
          id: 30,
          type: 'mcq',
          question: 'The discovery of saccharin occurred by accident during drug research.',
          options: ['YES', 'NO', 'NOT GIVEN']
        },
        {
          id: 31,
          type: 'mcq',
          question: 'The company 3M should have supported Art Fry by funding his idea of Post-It Notes.',
          options: ['YES', 'NO', 'NOT GIVEN']
        },

<<<<<<< Updated upstream
        // Complete sentences (32-35)
=======
        // Matching group (A–H) for 32–35
>>>>>>> Stashed changes
        {
          id: 32,
          type: 'matchinggroup',
          ...
          displayId: '32–35',
<<<<<<< Updated upstream
          question: 'Questions 32–35: Complete each sentence with the correct ending (columns). Choose ONE option per row.',
          tableHeader: 'Sentence completion',
=======
          question: 'Questions 32–35: Match each statement (rows) with the correct option (A–H). Choose ONE option per row.',
>>>>>>> Stashed changes
          columns: [
...
>>>>>>> Stashed changes
        ...
        // Multiple choice (A, B, C, D)
        {
          id: 36,
          type: 'mcq',
          question: 'How do Austin and Devin advise companies to get out of the \'cone of expectation\'?',
          options: [
        ...
        },
        {
          id: 37,
          type: 'mcq',
          question: 'In recommending \'counter-intuitive\' thinking, what do Austin and Devin imply?',
          options: [
        ...
        },
        {
          id: 38,
          type: 'mcq',
          question: 'The writer describes the Empire Lager disaster in order to show that',
          options: [
            'success can come out of a business failure',
            'the majority of companies now value risk-taking',
        ...
        },
        {
          id: 39,
          type: 'mcq',
          question: 'Pure Blonde has been more successful than Empire Lager because',
          options: [
        ...
        },
        {
          id: 40,
          type: 'mcq',
          question: 'The writer concludes that creating a culture that learns from mistakes',
          options: [

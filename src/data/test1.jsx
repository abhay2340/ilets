const test1 = {
  parts: [
    {
      title: 'PASSAGE 1',
      passage: `The history of childhood has been a heated topic in social history since the highly influential book ‘Centuries of Childhood’, written by French historian Philippe Aries, emerging in 1960. He stated that ‘childhood’ is a concept created by modern society.

A
Whether childhood is itself a recent invention has been one of the most intensely debated issues in the history of childhood. Historian Philippe Aries asserts that children were viewed as miniature adults, with all the intellect and personality that this implies, in Western Europe during the Middle Ages (up to about the end of the 15th century). After scrutinizing medieval pictures and diaries, he concluded that there was no distinction between children and adults for they shared similar leisure activities and work; However, this does not mean children were neglected, forsaken or overlooked, he argued. The idea of childhood corresponds to awareness about the peculiar nature of childhood, which distinguishes the child from adults, even the young adults. Therefore, the concept of childhood is not to be confused with affection for children.
...
C
In the 18th and 19th centuries, industrialization created a new demand for child labor; thus many children were forced to work for a long time in mines, workshops and factories. The issue of whether long hours of laboring would interfere with children's growing bodies began to perplex social reformers. Some of them begin to realize the potential of systematic studies to monitor how far these early deprivations might be involving children's development.

D
The concerns of reformers gradually had some impact on the working condition of children. For example, in Britain, the Factory Act of 1833 signified the emergence of the legal protection of children from exploitation and was also associated with the rise of schools for factory children. Due partly to factory reform, the worst forms of child exploitation were gradually eliminated. The influence of trade unions and economic changes also contributed to the evolution by leaving some forms of child labor redundancy during the 19th century. Initiating children into work as 'useful' children was no longer a priority, and childhood was considered to be a time for play and education for all children instead of a privileged minority. Childhood was increasingly understood as a more extended phase of dependence, development and learning with the delay of the age for starting full-time work—Even so, work continued to play a significant, if less essential, role in children's lives in the later 19th and 20th centuries. Finally, the 'useful child' has become a controversial concept during the first decade of the 21st century, especially in the context of global concern about large numbers of children engaged in child labor.

E
The half-time schools established upon the Factory Act of 1833 allowed children to work and attend school. However, a significant proportion of children never participated in school in the 1840s, and even if they did, they dropped out by the age of 10 or 11. By the end of the 19th century in Britain, the situation changed dramatically, and schools became the core to the concept of a ‘normal’ childhood.

F
It is no longer a privilege for children to attend school and all children are expected to spend a significant part of their day in a classroom. Once in school, children's lives can be separated from domestic life and the adult world of work. In this way, school turns into an institution dedicated to shaping the minds, behaviors and morals of the young. Besides, education dominates the management of children's waking hours through the hours spent in the classroom, homework (the growth of ‘after school’ activities), and the importance attached to parental involvement.
...
Industrialisation, urbanization and mass schooling pose new challenges for those who are responsible for protecting children's welfare, as well as promoting their learning. An increasing number of children are being treated as a group with unique needs, and are organized into groups in the light of their age. For instance, teachers need to know some information about what to expect of children in their classrooms, what kinds of instruction are appropriate for different age groups, and what is the best way to assess children's progress. Also, they want tools enabling them to sort and select children according to their abilities and potential.`,
      ...
      questions: [
        // TRUE / FALSE / NOT GIVEN
        {
          id: 1,
          type: 'mcq',
          question: 'Aries points out that children did different types of work to adults during the Middle Ages.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 2,
          type: 'mcq',
          question: 'Working children during the Middle Ages were generally unloved.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 3,
          type: 'mcq',
          question: 'Some scientists thought that overwork might damage the health of young children.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 4,
          type: 'mcq',
          question: 'The rise of trade unions largely contributed to the protection of children from exploitation in the 19th century.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 5,
          type: 'mcq',
          question: 'By the aid of half-time schools, most children went to school in the mid-19th century.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 6,
          type: 'mcq',
          question: 'In the 20th century, almost all children needed to go to school with a full-time schedule.',
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },
        {
          id: 7,
          type: 'mcq',
          question: "Nowadays, children's needs are much differentiated and classified based on how old they are.",
          options: ['TRUE', 'FALSE', 'NOT GIVEN']
        },

        // WRITTEN (text-input) answers
        {
          id: 8,
          type: 'written',
          question: 'What had not become a hot topic until the French historian Philippe Aries\' book caused great attention?'
        },
        {
          id: 9,
          type: 'written',
          question: 'According to Aries, what was the typical image of children in Western Europe during the Middle Ages?'
        },
        {
          id: 10,
          type: 'written',
          question: 'What historical event generated the need for a large number of children to work for a long time in the 18th and 19th centuries?'
        },
        {
          id: 11,
          type: 'written',
          question: 'What bill was enacted to protect children from exploitation in Britain in the 1800s?'
        },
        {
          id: 12,
          type: 'written',
          question: 'Which activities were becoming regarded as preferable for almost all children in the 19th century?'
        },
        {
          id: 13,
          type: 'written',
          question: 'In what place did children spend the majority of time during their day in school?'
        }
      ]
    },
    {

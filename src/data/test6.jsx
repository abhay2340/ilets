...
for the use of the emperor, his close relations
actually existed before the Silk Road2 was
and the very highest of his dignitaries.Within
officially opened in the second century BC.An
the palace, the emperor is believed to have
Egyptian mummy with a silk thread in her
worn a rope of white silk; outside, he, his
hair, dating from 1070 BC, has been
principal wife, and the heir to the throne wore
discovered in the village of Deir el Medina
yellow, the colour of the earth.
near the Valley of the Kings, and is probably
...
paintings, silk banners and textiles in caves
AD), silk ceased to be a mere fabric and
near Dunhuang, a trading station on the Silk
became a form of currency.Farmers paid
Road in north - west China.
...
nobility has now spread to all classes without
Byzantine church and state created imperial
workshops, monopolising production and
distinction – even to the lowest.’ The desire
for silk continued to increase over the
centuries.Despite this demand, the price of
silk remained very high.
In spite of their secrecy about
production methods, the Chinese eventually
lost their monopoly on silk production.
Knowledge of silk production methods
reached Korea around 200 BC, when waves of
Chinese immigrants arrived there.Shortly
after 300 AD, it travelled westward, and the
cultivation of the silkworm was established in
    India.
keeping the secret to themselves.This
allowed a silk industry to be established,
    undercutting the market for ordinary - grade
Chinese silk.However, high quality silk
textiles, woven in China especially for the
Middle Eastern market, continued to achieve
high prices in the West, and trade along the
Silk Road continued as before.By the sixth
century the Persians, too, had mastered the
art of silk weaving, developing their own rich
patterns and techniques.But it wasn't until
the 13th century that Italy began silk
...
Global silk production has declined in recent years.`,
        ...
        },
        {
          ...
          Studies are ongoing, but Lyuba has begun to shed the secrets of her short life and some clues to the fate of her kind. Her good general health was shown in the record of her dental development, a confirmation for Fisher that dental research is useful for evaluating health and thus key to investigating the causes of mammoth extinction. Analysis of her well-preserved DNA has revealed that she belonged to a distinct population of Mammuthus primigenius and that, soon after her time, another population migrating to Siberia from North America would take their place. Finally, Lyuba's premolars and tusks revealed that she had been born in late spring and was only a month old when she died.`,
            questions: [
                // Paragraph-identification (options A-F)
                {
                    id: 14,
                    type: 'mcq',
                    question: 'Which paragraph contains information about similarities between studies of mammoth remains from different parts of the world?',
                    options: ['A', 'B', 'C', 'D', 'E', 'F']
                },
                {
                    id: 15,
                    type: 'mcq',
                    question: 'Which paragraph contains details of the uses to which mammoth body parts were put?',
                    options: ['A', 'B', 'C', 'D', 'E', 'F']
                },
                {
                    id: 16,
                    type: 'mcq',
                    question: 'Which paragraph contains a theory that accounts for the damage to Lyuba’s face?',
                    options: ['A', 'B', 'C', 'D', 'E', 'F']
                },
                {
                    id: 17,
                    type: 'mcq',
                    question: 'Which paragraph contains an explanation of how an individual was able to identify a small corpse?',
                    options: ['A', 'B', 'C', 'D', 'E', 'F']
                },
                {
                    id: 18,
                    type: 'mcq',
                    question: 'Which paragraph contains a comparison between Lyuba and other young mammoth corpses?',
                    options: ['A', 'B', 'C', 'D', 'E', 'F']
                },
                ...
                // Short answer (24-26) — NO MORE THAN TWO WORDS
                {
                    id: 24,
                    type: 'written',
                    question: 'Some researchers say that a marked rise in temperature impacted on mammoths by changing the type of ______ available.',
                    maxWords: 2
                },
                {
                    id: 25,
                    type: 'written',
                    question: 'Fisher concluded that many of the mammoth tusks he looked at displayed signs of ______.',
                    maxWords: 2
                },
                {
                    id: 26,
                    type: 'written',
                    question: 'Not long after Lyuba’s death, the Mammuthus primigenius group she belonged to was replaced by another group that came from ______.',
                    maxWords: 2
                }
            ]
        }
...
greatness, but that inborn traits may not be the only cause.`,
            questions: [
                // MULTIPLE CHOICE (Choose correct letter A–D)
                {
                    id: 27,
                    type: 'mcq',
                    question: "In the first paragraph, the writer suggests that a musician who is 'talented' is someone",
                    options: [
                ...
                },
                {
                    id: 28,
                    type: 'mcq',
                    question: "According to the writer, what is unclear about the findings of Gottfried Schlaug?",
                    options: [
                ...
                },
                {
                    id: 29,
                    type: 'mcq',
                    question: 'According to the writer, what has been established by studies of violin players?',
                    options: [
                ...
                },
                {
                    id: 30,
                    type: 'mcq',
                    question: 'According to the writer, findings on the amount of practice done by expert musicians suggest that',
                    options: [
                ...
                // YES / NO / NOT GIVEN
                {
                    id: 31,
                    type: 'mcq',
                    question: "Anders Ericsson's work with cognitive psychology has influenced other researchers.",
                    options: ['YES', 'NO', 'NOT GIVEN']
                },
                {
                    id: 32,
                    type: 'mcq',
                    question: 'Different areas of expertise seem to have one specific thing in common.',
                    options: ['YES', 'NO', 'NOT GIVEN']
                },
                {
                    id: 33,
                    type: 'mcq',
                    question: 'In order to be useful, practice must be carried out regularly every day.',
                    options: ['YES', 'NO', 'NOT GIVEN']
                },
                {
                    id: 34,
                    type: 'mcq',
                    question: 'Anyone who practices for long enough can reach the level of a world-class expert.',
                    options: ['YES', 'NO', 'NOT GIVEN']
                },
                {
                    id: 35,
                    type: 'mcq',
                    question: 'Occasionally, someone can become an expert at global level with fewer than 10,000 hours’ practice.',
                    options: ['YES', 'NO', 'NOT GIVEN']
                },
                {
                    id: 36,
                    type: 'mcq',
                    question: 'Existing knowledge of learning and cognitive skills supports the importance of practice.',
                    options: ['YES', 'NO', 'NOT GIVEN']
                },

                // SUMMARY COMPLETION (choose A–J)
                {
                    id: 37,
                    type: 'mcq',
                    question: 'Complete the summary using the list of words A–J below (part 1)',
                    options: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J']
                },
                {
                    id: 38,
                    type: 'mcq',
                    question: 'Complete the summary using the list of words A–J below (part 2)',
                    options: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J']
                },
                {
                    id: 39,
                    type: 'mcq',
                    question: 'Complete the summary using the list of words A–J below (part 3)',
                    options: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J']
                },
                {
                    id: 40,
                    type: 'mcq',
                    question: 'Complete the summary using the list of words A–J below (part 4)',
                    options: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J']
                }
            ]
